...
(5) Subir a la aplicación web con el comando:
    ...
    az webapp deployment source config-zip --resource-group "Nombre del grupo de recursos" --name "Nombre de la aplicación web" --src "nombre del archivo zip     que vas a publicar"