...
// DBTITLE 1,Etiquetador
"""
El Etiquetador asignará una etiqueta a cada mensaje de la base que reciba como insumo, dicha etiqueta corresponde a un tópico o tema del diccionario que reciba como insumo, esto por medio de la intersección de bolsas de N-gramas, tomando el mejor nivel de afinidad.
...
// MAGIC 
// MAGIC #------------------- Registros
// MAGIC Data = pd.read_excel('/dbfs/mnt/parce/03_Base_principal_ngrams.xlsx',sheet_name='Sheet1', engine='openpyxl')
...
// MAGIC Cruz5 = Cruz5[['Intencion','Usuario','Etiqueta']]
// MAGIC 
// MAGIC Cruz5.count()
...
// MAGIC 
// MAGIC #Cruz5.show()
// MAGIC #print('Interacción: '+ Cruz5.collect()[0]['Usuario'], 'Etiqueta: '+ Cruz5.collect()[0]['Etiqueta'])
...
// MAGIC 
// MAGIC """
// MAGIC Guardar dataframe final (Cruz5) en el contenedor (resultados)
// MAGIC """
// MAGIC 
...
// MAGIC dbutils.fs.mv(output_file[0].path, "%s/01_Datos_etiquetados_27072021.csv" % output_container_path)
